...
import com.goldbuild.javafaker.AbstractFakerTest;
import com.goldbuild.javafaker.Faker;
import com.goldbuild.javafaker.Superhero;
...
public class FakeValuesServiceTest extends AbstractFakerTest {
    ...
    public void bothify2Args() {
        ...
        assertThat(value, MatchesRegularExpression.matchesRegularExpression("[A-Z]{2}\\d{2}"));
    }
    ...
    public void expressionWithFourArguments() throws ParseException {
        ...
        assertThat(fakeValuesService.expression("#{Internet.password '5','8','true','true'}", faker),
            MatchesRegularExpression.matchesRegularExpression("[\\w\\d\\!%#$@_\\^&\\*]{5,8}"));
    }
